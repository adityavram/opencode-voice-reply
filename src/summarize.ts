// Summarizer orchestrator — decides how to summarize text.
// Short messages (≤ threshold) are cleaned verbatim (no LLM call).
// Long messages use the configured backend (OCODE_VOICE_SUMMARIZER=llm|deterministic).
// LLM failures automatically fall back to deterministic.
